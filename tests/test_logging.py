...
from niiotrace import NiIOTraceError, StatusCode
...
class TestIOTraceHandler:
    @patch("niiotrace.logging.log_message")
    ...
    @patch("niiotrace.logging.log_message")
    def test_emit_handles_error_on_niiotrace_error(self, mock_log_message, logger, handler):
        mock_log_message.side_effect = NiIOTraceError(StatusCode.FAILED_GUI_CLOSED)
